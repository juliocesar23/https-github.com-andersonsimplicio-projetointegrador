...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        Dialog.setObjectName("Cadastro Cliente")
...
"}")
    ...
    def CadastroSalvar(self):
        ...
        if self.valido == True:
            print(self.cmpCodigo.text())
            print(self.cmpRazaoSocial.text())
            print(self.cmpNomeFantasia.text())
            print(self.cmpCnpjCpf.text())
            print(self.cmpInscricaoEstadual.text())
            print(self.cmpInscricaoEstadual_2.text())
    ...
    def retranslateUi(self, Dialog):
        self.valido = False#inicializa o cadastro como falso e muda ao validar todos os campos
